<?php
# 签到活动信息
$signin = $_QFG['db']->result("select signin from app_qqfarm_mc where uid=".$_QFG['uid']);
...
$_QFG['db']->query("update app_qqfarm_mc set signin='".qf_encode($signin)."' where uid=".$_QFG['uid']);
