...
//输出信息
echo '{"log":' . $mclog . ',"user":{"homePage":"' . qf_getHomePage($uId) . '","money":' . $money . ',"uExp":' . $exp . ',"moralexp":'.(int)$beasts['moralexp'].',"uId":' . $uId . ',"uLevel":' . qf_toLevel($exp) . ',"uName":"' . qf_getUserName($uId) . '"}}';
