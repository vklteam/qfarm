...
if($money < $money_1) {
	die('{"errorContent":"你的金币不足。","errorType":"1011"}');
}
...
echo '{"addExp":' . ($number * 5) . ',"animal":' . qf_jsonCode($buyanimal) . ',"code":0,"money":' . ($animaltype[$cid]['price'] * $number) . ',"msg":"success","num":' . $number . ',"ecode":0,"poptype":3}';
