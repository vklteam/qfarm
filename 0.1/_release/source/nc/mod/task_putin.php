...
if($fruit['167'] <= 0) die('{"code":-12,"errorContent":"您没有糖果，无法继续投放。","type":1}');
if($npc['nc_day'] <= 0) die('{"code":-12,"errorContent":"您今天已经投放糖果10次了，无法继续投放，明天再来吧。","type":1}');

if(array_key_exists($_QFG['uid'], $ownernpc['ncput'])>0) die('{"code":-13,"errorContent":"您今天已经在该好友的盒子中投放过糖果了，去别人农场里看看吧。","type":1}');
