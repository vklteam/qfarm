...
if($sfeedleft == 0) {
	die('{"errorContent":"当前牧场今天已被喂30个特殊作物，明天再来","errorType":"1001","serial":' .  $_REQUEST['serial'] . ',"sfeedleft":' . $sfeedleft . '}');
}
...
if ($animal[$serial]['cId']==1002){
	...
	die('{"errorContent":"只能供兔子、猴子、松鼠使用","errorType":"1001","serial":' .  $_REQUEST['serial'] . ',"sfeedleft":' . $sfeedleft . '}');
}
