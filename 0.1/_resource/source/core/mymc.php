...
$mod_list = array(
	...
	'cgi_get_food', //买草
	'cgi_get_notice', //牧场公告
	'cgi_farm_get_common_notice',//牧场公告
	'gb_buy', //元宝购买
	...
	'shop_verify',
	'sysmsg_select',
	'cgi_pasture_login_home',//签到提示
	'cgi_pasture_login_click',//签到
	'cgi_signin',//签到
	...
	'cgi_return_gift',
	'cgi_farm_shop_verify',
	'cgi_fetch_package_flags',//中秋国庆活动
	'cgi_farm_ceremony_package',//中秋国庆活动
	'cgi_get_thanks_package',//中秋国庆活动
	'cgi_sale_cub',//回收动物
	'cgi_fetch_strategy_rules',//万圣节活动
	'cgi_pasture_create_animal',//万圣节活动
	'cgi_pasture_crystal_blessing',//万圣节活动
	'cgi_pasture_adopt_animal',//万圣节活动
	'cgi_pasture_research',//科研
	'cgi_pasture_hourglass',//加沙漏
	'cgi_pasture_shop_pay',//新元宝
	'cgi_farm_get_bit',//科研
	'cgi_farm_tree',
	'hydra_feeds_select',
	'hydra_feeds_delete',
	'cgi_farm_tree_mcqqalarmclock',
	'get_userprop',
	'cgi_risk_get_info',//牧场大冒险
	'my_calendar_agenda_batch_get',//牧场大冒险
	'cgi_risk_break_checkpoint',//牧场大冒险
	'cgi_risk_collect_single_award',//牧场大冒险
	'cgi_risk_cancel_award'//牧场大冒险
);
