...
//$_QFG['db']->query("ALTER TABLE app_qqfarm_nc add column `black` text", "quiet");
$_QFG['db']->query("ALTER TABLE app_qqfarm_mc add column `research` text", "quiet");


die('OK. 升级成功 QFarm 7.0 Final');
