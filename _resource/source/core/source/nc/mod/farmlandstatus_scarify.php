...
if($status[$place]['b']<7 && $cropStatus==7) die('{"code":0,"direction":"请求已经过期，请重进农场","farmlandIndex":'.$place.',"poptype":1}');
if($status[$place]['a']>0) {
...
} else echo '{"farmlandIndex":' . $place . ',"code":0,"poptype":1,"direction":"已经锄过这块地了哟！"}';
